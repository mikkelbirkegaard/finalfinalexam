...
?>
<section class="flexible-inner-section bbh-inner-section logo-slider-wrapper <?php echo $add_become_costumer ? 'logo-white-bg' : 'just-logo-slider' ?>" data-animation="fadeIn">
