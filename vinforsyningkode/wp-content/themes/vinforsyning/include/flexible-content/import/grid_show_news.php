...
$choose_news_second = get_sub_field('choose_news_second');
 ...
 <section class="flexible-inner-section bbh-inner-section" data-animation="fadeIn">
   <div class="grid-container">
     <div class="row">
       <div class="col-sm-12 news-section-grid">
       ...
       <div class="col-sm-12">
           <div class="ordinary-news-wrapper" data-animation="fadeIn">
               <?php if ( have_rows( 'vaelg_andre_nyheder' ) ) : ?>
    	              <?php while ( have_rows( 'vaelg_andre_nyheder' ) ) :
    		                    the_row();
                                $choose_news_ordinary = get_sub_field('choose_news_ordinary');
                                ?>
                                <div class="ordinary-news">
                                    <?php if ($choose_news_ordinary):
                                      $post = $choose_news_ordinary;
                                      setup_postdata($post);
                                      ?>
