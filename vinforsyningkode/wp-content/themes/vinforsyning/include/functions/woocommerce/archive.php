...
function bbh_setup_woo_archive_structure(){
	add_action('woocommerce_before_shop_loop_item', 'bbh_archive_product_top', 10);
	...
	remove_action( 'woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_product_thumbnail', 10 );
	add_action('woocommerce_after_shop_loop_item', 'bbh_woo_archive_image', 40);
...
/*=============================================
          = product image  =
===============================================*/
function bbh_woo_archive_image() {
	echo '</div>'; // Close the product-item-wrap div
    global $product;
    $image = get_post_thumbnail_id();
    $placeholder = get_option( 'woocommerce_placeholder_image', 0 );
    ?>
    <div class="product-image-wrap">
        <a class="image-full-width" href="<?php echo esc_url( get_permalink( $product->get_id() ) ); ?>" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
            <div class="image">
