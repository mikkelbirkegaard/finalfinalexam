...
<table class="email_builder_table_items" cellspacing="0" cellpadding="6" style="width: 100% !important;" border="1" width="100%">
	...
	<tr>
		...
		<th class="td" scope="col" style="text-align:left;"><?php _e( 'Årgang', 'woocommerce' ); ?></th>
		<th class="td" scope="col" style="text-align:left;"><?php _e( 'Volume', 'woocommerce' ); ?></th>
		<th class="td" scope="col" style="text-align:left;"><?php _e( 'Pris', 'woocommerce' ); ?></th>
		<th class="td" scope="col" style="text-align:left;"><?php _e( 'Kolli', 'woocommerce' ); ?></th>
		<th class="td" scope="col" style="text-align:left;"><?php _e( 'Quantity', 'woocommerce' ); ?></th>
		<th class="td" scope="col" style="text-align:left;"><?php _e( 'Subtotal', 'woocommerce' ); ?></th>
	</tr>
	</thead>
	<tbody>
	<?php
	...
	if ( $totals = $order->get_order_item_totals() ) {
		...
		foreach ( $totals as $total ) {
			$i++;
			?><tr>
			<th class="td" scope="row" colspan="6" style="text-align:left; <?php if ( $i === 1 ) echo 'border-top-width: 1px'; ?>"><?php echo $total['label']; ?></th>
