...
$cpt = 'vinforslag-til-mad';
 ...
 <script src="/wp-content/themes/vinforsyning/assets/js/bbh_search_ajax.js?version=<?php echo filemtime(get_stylesheet_directory() . '/assets/js/bbh_search_ajax.js'); ?>"></script>
 </section>
